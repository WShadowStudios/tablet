...
surfacelight.Range = 80
surfacelight.Angle = 70
...
local function ScannerStaticStart()
	...
	TweenService:Create(ScannerViewportFrame.Vignette, TweenInfo.new(1, Enum.EasingStyle.Quart, Enum.EasingDirection.InOut), {
